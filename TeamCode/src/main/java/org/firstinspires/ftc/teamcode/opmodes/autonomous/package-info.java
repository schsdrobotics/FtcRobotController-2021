 ...
 * WarehousePreload - Warehouse side -> Preload -> intake cycles -> park in warehouse (warehouse side main)
 * Warehouse - Warehouse side -> Preload -> park in warehouse (warehouse side backup)
